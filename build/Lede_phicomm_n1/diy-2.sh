...
sed -i '$i '"src-git helloworld https://github.com/fw876/helloworld"'' feeds.conf.default
sed -i '$i '"src-git passwall https://github.com/xiaorouji/openwrt-passwall"'' feeds.conf.default
sed -i '$i '"src-git OpenClash https://github.com/vernesong/OpenClash"'' feeds.conf.default
sed -i '$i '"src-git jerrykuku https://github.com/jerrykuku/luci-app-vssr"'' feeds.conf.default
